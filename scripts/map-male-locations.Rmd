...
*Inputs*: Capture data ("capture-data.csv") and GPS data ("gps-data.csv")

*Outputs*: A summary of longer trips away from the site is exported as "male-trips-offsite.csv"
