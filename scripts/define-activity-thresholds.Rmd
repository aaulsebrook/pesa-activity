...
2. Check whether there are more on-board processed data available for these videos (as opposed to the raw data): <i> there aren't </i>
...
* Tag 020a (low but just before second peak)?
* Tag 021a (one of the focal birds, but threshold appears a little low)
* Tag 022b (low but just before second peak)
* Tag 025b (but just before second peak)
* Tag 025e (maybe a little low)
* Tag 026c: Threshold much too high. Try different seed?
* Tag 0214 (just below second peak)
* Tag 0220: Threshold appears too high; either use first or try a different seed
* Tag 0244: Threshold too high (439)
* Tag 0246: Threshold too high. 
* Tag 0248 (appears low-ish)
* Tag 0254: Threshold too low
* Tag 0265 (low but just before second peak)
* Tag 0267: Threshold too high
* Tag 0269 (low but just before second peak)
...
* Tag 020a (low but just before second peak) - slightly improved
* Tag 021a (one of the focal birds) - improved
* Tag 025b (but just before second peak) - improved
* Tag 025e (maybe a little low) - slightly improved but very similar
* Tag 026c: Now looks good
* Tag 0248 (appears low-ish) - improved, looks good
* Tag 0265 (low but just before second peak) - improved, looks good
* Tag 0269 (low but just before second peak) - improved, looks ok enough
...
* Tag 0214 (just below second peak) - same
* Tag 0220: Still too high
* Tag 022b (low but just before second peak) - same
* Tag 0244: Threshold too high
* Tag 0246: Threshold too high. 
...
* Tag 0244: Threshold was too high - then worse, even higher - now improved, looks good
* Tag 0246: Threshold was too high - now improved, looks ok
* Tag 0254: Threshold was too low, then too high - looks great now
...
* Tag 0220: - too high still. Might work better to use four modes for this one: lots of high values (i.e. flying)
* Tag 022b (low but just before second peak). Might work better to use four modes for this one.
* Tag 0267: Threshold too high - still too high. Might work better to use four modes for this one.
